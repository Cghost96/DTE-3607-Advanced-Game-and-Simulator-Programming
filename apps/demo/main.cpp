...
int main(int argc, char* argv[]) {
  ...
  /* ------------------------------- PROJECT SCENARIOS ------------------------------- */
  /* --------------------------------------------------------------------------------- */
  guiapp.registerScenarioGaltonVerticalFallFlatGround01();
  guiapp.registerScenarioGaltonRollSlopedGround01();
  guiapp.registerScenarioGaltonRollSlopedGround02();
  guiapp.registerScenarioGaltonRollSlopedGround03();
  guiapp.registerScenarioGaltonRollSlopedGround04();
  guiapp.registerScenarioGaltonRollSlopedGround05();
  guiapp.registerScenarioGaltonRollingCollisionFlatGround01();
  guiapp.registerScenarioGaltonRollingCollisionAir01();
