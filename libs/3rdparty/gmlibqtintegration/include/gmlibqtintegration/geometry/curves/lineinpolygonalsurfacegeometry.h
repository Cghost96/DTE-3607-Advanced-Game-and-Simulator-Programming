#ifndef GMLIBQTINTEGRATION_GEOMETRY_CURVES_LINEINPOLYGONALSURFACEGEOMETRY_H
#define GMLIBQTINTEGRATION_GEOMETRY_CURVES_LINEINPOLYGONALSURFACEGEOMETRY_H


#include "../curveinpolygonalsurfacegeometry.h"
...
namespace gmqt
{
  ...
  class LineInPolygonalSurfaceGeometry
    : public CurveInPolygonalSurfaceGeometry {
    Q_OBJECT
  ...
  public:
    using CurveInPolygonalSurfaceGeometry::SurfaceType;
    using CurveInPolygonalSurfaceType
      = gm::parametric::CurveInPolygonalSurface<gm::parametric::Line,
                                                  SurfaceType::EmbedSpace>;

    LineInPolygonalSurfaceGeometry(QQuick3DObject* parent = nullptr)
      : CurveInPolygonalSurfaceGeometry(parent)
    {
    }
  ...
  private:
    ...
    std::unique_ptr<CurveInPolygonalSurfaceType> m_subcurve{nullptr};
    ...
    void updateInternalSubCurve() override {
      ...
      if( not m_subcurve ) {
        ...
        m_subcurve      = std::make_unique<CurveInPolygonalSurfaceType>(
...
#endif // GMLIBQTINTEGRATION_GEOMETRY_CURVES_LINEINPOLYGONALSURFACEGEOMETRY_H
