...
namespace dte3607::coldet::mechanics {
  ...
  inline std::optional<VT> detectCollisionSphereFixedPlane(TP const& tc, P3 const& p, VT r, V3 const& v, P3 const& q,
                                                           V3 const& n, V3 const& F, TP const& t_0, DT timestep) {
