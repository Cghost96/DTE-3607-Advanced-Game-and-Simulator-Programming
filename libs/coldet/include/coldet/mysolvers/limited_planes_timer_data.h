#ifndef LIMITED_PLANES_TIMER_DATA_H
#define LIMITED_PLANES_TIMER_DATA_H
...
namespace dte3607::coldet::mysolvers::limited_planes_timer_data {
  ...
  using fixture = std::unique_ptr<scenario_fixtures::Fixture_Os_Fs_ip_lp_cPsfp_sa_ds_t_counter_distribution>;
  ...
  void handleCollision(CollisionsOsFp& C_OsFp, [[maybe_unused]] CollisionsOss& C_Oss,
                       ...
                       Distribution& d_x, Distribution& d_z) {
      ...
      switch (collisions.back().second) {
        ...
        case '3':
          handleCollision(C_OsFp, C_Oss, C_OsFs, C_OsFlp, attachmentsOsFp, trajectories, G, timestep, t_0,
                          O_S, F_S, F_P, F_LP, s_index, d_x, d_z);
          scenario->counter()++;
          break;
        case '4':
...
#endif   // LIMITED_PLANES_TIMER_DATA_H
