...
namespace dte3607::coldet::mysolvers {
  ...
  requires concepts::scenario_fixtures::MySolverFixtureConcept01<SolverDevFixture_T> void
  solveSphereAndFixedPlanesNoExternalForces([[maybe_unused]] SolverDevFixture_T& scenario,
